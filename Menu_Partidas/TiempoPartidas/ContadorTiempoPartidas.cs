...
{
    /*
     * Verifica en que partida se esta jugando para activar el cronometro de la partida en curso
     * y muestra los datos en pantalla
     */
    ...
    //------------------------------------------------------------------------------------------//
    //FUNCION PARA DETECTAR PARTIDA EN CURSO----------------------------------------------------//
    //------------------------------------------------------------------------------------------//
    public void EnPartida(int Partida)
    {
        //Actualiza los valores en los otros scripts
        switch(Partida)
        {
    ...
    {
        //Actualiza los valores en este script
        if (EnPartida1)
        {
            EnPartida2 = false;
            EnPartida3 = false;
    ...
    //------------------------------------------------------------------------------------------//
    //FUNCION PARA CONTAR EL TIEMPO EN PARTIDA--------------------------------------------------//
    //------------------------------------------------------------------------------------------//
    ...
    //------------------------------------------------------------------------------------------//
    //MUESTRA EL TIEMPO TRANSCURRIDO EN CADA PARTIDA--------------------------------------------//
    //------------------------------------------------------------------------------------------//
